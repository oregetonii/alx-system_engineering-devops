#!/usr/bin/python3
"""
Function that queries the Rddit API and returns the number of subscribers for given subreddit
"""
import requests
...
def number_of_subscribers(subreddit):
    ...
    try:
        ...
        # If the response status code is 302, it indicates a redirect, possibly to search results
